    ...
    <div class="card card-outline card-primary">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="" class="control-label">Nom du décompte</label>
        ...
        <div class="card-footer border-top border-info">
            <div class="d-flex w-100 justify-content-center align-items-center">
                <button class="btn btn-flat bg-gradient-primary mx-2" form="manage-statement">Sauvegarder</button>
    ...
    $('#manage-statement').submit(function(e){
        ...
        $.ajax({
            ...
            success: function(resp){
                if (resp == 1){
                    alert_toast('décompte enregistrée avec succès.', 'success');
                    setTimeout(function(){
