    ...
    <div class="card card-outline card-primary">
            ...
            <form action="" id="manage-iso-terrain" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="" class="control-label">Nom du Chef de mission</label>
        ...
        <div class="card-footer border-top border-info">
            <div class="d-flex w-100 justify-content-center align-items-center">
                <button class="btn btn-flat bg-gradient-primary mx-2" form="manage-iso-terrain">Sauvegarder</button>
    ...
    $('#manage-iso-terrain').submit(function(e){
        ...
        $.ajax({
            ...
            success: function(resp){
                if (resp == 1){
                    alert_toast('Document ISO Terrain enregistré avec succès.', 'success');
                    setTimeout(function(){
