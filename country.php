    ...
    <div class="card card-outline card-success">
        ...
        <div class="card-body p-0">
            ...
            <style>
                ...
                .project-item {
                    display: block;
                    margin-bottom: 30px; /* Augmenter l'espace entre les projets */
                }
                .country-column {
            ...
            <div class="table-responsive" id="printable">
                <table class="table m-0 table-bordered">
                    ...
                    <tr>
                        ...
                        <th style="width: 20%; text-align: center; vertical-align: middle;">Pays</th>
                    ...
                    <?php
                    $i = 1;
                    $qry = $conn->query("SELECT c.country_id, c.name, GROUP_CONCAT(CONCAT(p.id, '|', p.name) SEPARATOR '||') as projects
                                        FROM country c 
                                        LEFT JOIN project_list p ON p.country_id = c.country_id
                                        GROUP BY c.country_id");
                    while ($row = $qry->fetch_assoc()):
                    ?>
                        <tr>
                            <td style="width: 10%; vertical-align: middle;"><span class="large-font"><?php echo $i++ ?></span></td>
                            <td class="country-column" style="width: 20%; vertical-align: middle;"><span class="large-font"><?php echo ucwords($row['name'] ?? '') ?></span></td>
                                ...
                                <span class="large-font">
                                    ...
                                    if (!empty($row['projects'])) {
                                        ...
                                        foreach ($projects as $project) {
                                            list($project_id, $project_name) = explode('|', $project, 2); // Diviser une seule fois
