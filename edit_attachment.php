...
if(isset($_GET['id'])) {
    $qry = $conn->query("SELECT * FROM attachment_list WHERE id = ".$_GET['id']);
...
<div class="col-lg-12">
    <div class="card card-outline card-primary">
        <div class="card-body">
            <form action="" id="manage-attachment" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="" class="control-label">Nom de l'attachement</label>
                    ...
                    <div class="col-md-6">
                        ...
                        <!-- File Upload Field -->
                        <div class="form-group">
                            <label for="file" class="control-label">Veuillez joindre la Attachement</label>
        ...
        <div class="card-footer border-top border-info">
            <div class="d-flex w-100 justify-content-center align-items-center">
                <button class="btn btn-flat bg-gradient-primary mx-2" form="manage-attachment">Mettre à jour</button>
                <button class="btn btn-flat bg-gradient-secondary mx-2" type="button" onclick="location.href='index.php?page=attachment_list'">Annuler</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    $('#manage-attachment').submit(function(e){
        e.preventDefault();
        start_load();
        $.ajax({
            url: 'ajax.php?action=save_attachment',
            ...
            success: function(resp){
                if (resp == 1){
                    alert_toast('Attachement mise à jour avec succès.', 'success');
                    setTimeout(function(){
                        location.href = 'index.php?page=attachment_list';
                    }, 1500);
                }
            }
        });
