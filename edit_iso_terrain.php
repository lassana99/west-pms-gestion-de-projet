...
if (isset($_GET['id'])) {
    $qry = $conn->query("SELECT * FROM iso_terrain_list WHERE id = " . $_GET['id']);
...
<div class="col-lg-12">
    <div class="card card-outline card-primary">
        <div class="card-body">
            <form action="" id="manage-iso-terrain" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label class="control-label">Nom du Chef de mission</label>
        ...
        <div class="card-footer border-top border-info">
            <div class="d-flex w-100 justify-content-center align-items-center">
                <button class="btn btn-flat bg-gradient-primary mx-2" form="manage-iso-terrain">Mettre à jour</button>
                <button class="btn btn-flat bg-gradient-secondary mx-2" type="button" onclick="location.href='index.php?page=iso_terrain_list'">Annuler</button>
            </div>
        </div>
    </div>
</div>
...
$('#manage-iso-terrain').submit(function(e){
    e.preventDefault();
    start_load();
    $.ajax({
        url: 'ajax.php?action=save_iso_terrain',
        ...
        success: function(resp){
            if (resp == 1){
                alert_toast('Projet ISO Terrain mis à jour avec succès.', 'success');
                setTimeout(function(){
                    location.href = 'index.php?page=iso_terrain_list';
                }, 1500);
            }
        }
    });
