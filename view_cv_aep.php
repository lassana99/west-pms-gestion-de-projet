...
<head>
    ...
    <style>
        ...
        #cv-aep-view .left-section, #cv-aep-view .right-section {
            width: 48%;
        ...
        #cv-aep-view .vertical-separator {
            border-left: 2px solid #007bff;
            height: 100%;
            margin: 0 20px;
        }
        #cv-aep-view .description-section {
            background-color: #f9f9f9;
            border: 1px solid #ddd;
            border-radius: 4px;
            padding: 20px;
        ...
        #cv-aep-view .description-section h3 {
            margin-top: 0;
            font-size: 1.2em;
            font-weight: bold;
        }
        #cv-aep-view .description-section p {
            font-size: 1em;
        }
        #cv-aep-view .file-name-container {
            display: flex;
            justify-content: space-between;
            margin-top: 20px;
        }
        #cv-aep-view .file-name-section,
        #cv-aep-view .file-actions-section {
            flex: 1;
            padding: 10px;
            background-color: #ffffff;
            border: 1px solid #ddd;
        ...
        #cv-aep-view .file-name-section label,
        #cv-aep-view .file-actions-section label {
            font-weight: bold;
            display: block;
            margin-bottom: 5px;
            font-size: 1.2em;
        }
        #cv-aep-view .file-name,
        #cv-aep-view .icons {
            font-size: 1em;
        }
        #cv-aep-view .icons {
        ...
        #cv-aep-view .icons a i.fas.fa-edit {
            color: #007bff;
        }
        #cv-aep-view .icons a i.fas.fa-download {
            color: #28a745;
        }
        #cv-aep-view .icons a:hover i {
            opacity: 0.8;
        }
    </style>
</head>
            ...
            <div class="file-actions-section">
                ...
                <div class="icons d-flex justify-content-start">
                    <div class="text-center mr-3">
                        <a href="./index.php?page=edit_cv_aep&id=<?php echo $id; ?>" title="Modifier le CV aep">
                    ...
                    <div class="text-center">
                        <a href="assets/cv_aep/<?php echo htmlspecialchars($file_name ?? ''); ?>" download title="Télécharger le fichier">
