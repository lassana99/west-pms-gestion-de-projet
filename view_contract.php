...
<head>
    ...
    <style>
        ...
        #contract-view .contract-container {
            max-width: 1200px;
            margin: 20px auto;
            padding: 20px;
        ...
        #contract-view .left-section, #contract-view .right-section {
            width: 48%;
        ...
        #contract-view .file-name-container .file-actions-section {
            flex: 1;
            padding: 10px;
            background-color: #ffffff;
            border: 1px solid #ddd;
        ...
        #contract-view .file-name-section label,
        #contract-view .file-actions-section label {
            font-weight: bold;
            display: block;
            margin-bottom: 5px;
            font-size: 1.2em; /* Increase font size */
        }
        #contract-view .file-name-section .file-name,
        #contract-view .file-actions-section .icons {
        ...
        #contract-view .file-actions-section .icons a {
            text-decoration: none;
            font-size: 2em; /* Increase icon size */
        }
        #contract-view .file-actions-section .icons a i.fas.fa-edit {
            color: #007bff; /* Blue color for the edit icon */
        }
        #contract-view .file-actions-section .icons a i.fas.fa-download {
            color: #28a745; /* Green color for the download icon */
        }
        #contract-view .file-actions-section .icons a:hover i {
...
<body>
        ...
        <div class="contract-container">
            <div class="contract-content">
                <div class="left-section">
                    <dl>
                        <dt><b>Nom du contrat :</b></dt>
                        <dd><?php echo htmlspecialchars($name ?? 'Non défini'); ?></dd>
                        <dt><b>Client :</b></dt>
                        <dd><?php echo htmlspecialchars($lessor ?? 'Non défini'); ?></dd>
                        <dt><b>Pays :</b></dt>
    ...
    <div class="icons d-flex justify-content-start">
        ...
        <div class="text-center">
            <a href="assets/docs/<?php echo htmlspecialchars($file_name ?? ''); ?>" download title="Télécharger le contrat">
