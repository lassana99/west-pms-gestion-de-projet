...
if (isset($_GET['id'])) {
    $qry = $conn->query("SELECT * FROM cv_route_list WHERE id = " . $_GET['id']);
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control form-control-sm" name="speciality" id="speciality-select">
                                ...
                                <?php
                                $options = [
                                    "Ing. Ouvrage d'art", "Ing. Routier", "Ing. Géotechnicien", "Ing. Topographe", 
                                    "Ing. Environnementaliste", "Spécialiste Sécurité Routière", "Hydrolicien", "Socio économiste",
                                    "Ing. Qualité", "Economiste de transport"
                                ];
                                foreach ($options as $opt) {
                                    $selected = (isset($speciality) && $speciality == $opt) ? 'selected' : '';
                            ...
                            <input type="text" class="form-control form-control-sm mt-2" name="speciality_other" id="speciality-other" placeholder="Veuillez préciser votre spécialité" 
                                value="<?php echo (isset($speciality) && !in_array($speciality, $options)) ? htmlspecialchars($speciality) : '' ?>" 
                                style="display: none;">
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" cols="30" rows="10" class="summernote form-control"><?php echo isset($description) ? htmlspecialchars($description) : '' ?></textarea>
                        </div>

                        <div class="form-group">
                            <label class="control-label">Veuillez joindre le CV</label>
